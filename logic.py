...
def Q1():#Strats/Ends with alphabet
    q1_input=input("Enter input aplphabets(separated by white-space): ").split()
...
def Q2():# Occurence of alphabet
    q2_input=input("Enter input aplphabets(separated by white space): ").split()

    q2_occurencealpha=input("Enter alphabets to occur: ").split()

    q2_count=[]
    for i in range(len(q2_occurencealpha)):
        # print("Enter occurence of '"+q2_occurencealpha[i]+"' : ")
        n=int(input("Enter occurence of '"+q2_occurencealpha[i]+"' : "))
        q2_count.append(n)
    q2_countall=[]
...
def Q3():#Must include string
    q3_input=input("Enter input aplphabets(separated by white-space): ").split()
...
def Q4():#even & odd occ. 
    q4_input=input("Enter input aplphabets(separated by white-space): ").split()
...
def Q5():# Inequalities of string
    q5_input=input("Enter input alphabets(separated by white-space): ").split()
...
def Q6():#Do not contain 
    q6_input=input("Enter input alphabets(separated by white-space): ").split()
...
def Q7():#Must include and starts/ends with
    q7_input=input("Enter input alphabets(separated by white-space): ").split()
    ...
    if(check(q7_userstring, q7_input)==1):
        ...
        if(len(q7_startswith)!=0 and len(q7_endswith)==0):
            if(q7_chechstart(q1_userstring, q7_startswith)==1 and q7_userstring.count(q7_occrenceofalpha)==int(q7_nooccrence)):
                print("VALID\n")
...
def Q8():# Contain + Not contain
    ...
    q8_input=input("Enter input alphabets(separated by white-space): ").split()
...
def Q10():#Must include + inequalities of string
    ...
    q10_input=input("Enter input alphabets(separated by white-space): ")
